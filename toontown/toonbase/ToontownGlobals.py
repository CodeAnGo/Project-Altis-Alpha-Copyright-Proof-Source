...
MinigamePlayerMatrix = {
    1: (CannonGameId, MazeGameId, TugOfWarGameId, RingGameId, VineGameId, CogThiefGameId, DivingGameId, PairingGameId, CatchGameId, TargetGameId, PhotoGameId),
    2: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, TagGameId, RingGameId, VineGameId, IceGameId, CogThiefGameId, DivingGameId, PairingGameId, CatchGameId, TargetGameId, PhotoGameId),
    3: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, RaceGameId, TagGameId, VineGameId, RingGameId, IceGameId, CogThiefGameId, DivingGameId, PairingGameId, CatchGameId, TargetGameId, PhotoGameId),
    4: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, RaceGameId, TagGameId, VineGameId, RingGameId, IceGameId, CogThiefGameId, DivingGameId, PairingGameId, CatchGameId, TargetGameId, PhotoGameId),
}
